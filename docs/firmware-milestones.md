...
> | (commit on push) | feat(softap): minimal provisioning home page (GET / with HTML form) | scope expansion 2026-08-22 (user-directed; no new R-id) |
>
